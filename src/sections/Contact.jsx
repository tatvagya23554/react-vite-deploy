  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.sendForm(
        ...
        formRef.current, import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY
      );
      ...
      <div className="w-full h-full md:px-10 px-5">
        ...
        <div className="grid-12-cols mt-16">
          ...
          <div className="xl:col-span-7 min-h-96">
            <div className="bg-[#cd7c2e] w-full h-full hover:cursor-grab rounded-3xl overflow-hidden"><ContactExperience /></div>
          </div>
        </div>
      </div>
    </section>
